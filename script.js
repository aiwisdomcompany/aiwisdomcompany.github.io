...
const projects = [
  {
    ...
    description: "打造「暴力鴨研究所」導入 AI Agent、AEO／GEO 與導購流程，提升商品被 AI 發現與詢單轉換。",
  ...
  },
  {
    name: "保全公司官網",
    type: "Corporate Site",
    description: "以 AI 自動分流、回覆與追蹤客戶，縮短 B2B 洽詢流程並提升轉換效率。",
    link: "",
  ...
  },
  {
    ...
    type: "Automation",
    description: "整合既有 Airtable 資料庫與工作流程，打造 AI Agent 工作平台，自動化報價、帳款與應收分析，加速日常營運。",
    link: "",
